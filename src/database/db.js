...
const pool = new Pool({
  connectionString:
  "postgres://default:VDzHSGJ6doI3@ep-sparkling-fog-63743136.us-east-1.postgres.vercel-storage.com:5432/verceldb",
  ssl: {
...
const createTables = async () => {
  try {
    ...
    CREATE TABLE IF NOT EXISTS homenagem_instituicao (
      ...
      id_instituicao SERIAL REFERENCES instituicao(id_insituicao),
      PRIMARY KET (id_homenagem, id_instituicao)
    )
